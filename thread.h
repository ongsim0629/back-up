...
/* Updates the thread's priority based on donations. */
void thread_update_priority(struct thread *t);
void update_priority(struct thread *t);

/* Compares threads by priority (used in list operations). */
bool list_higher_priority(const struct list_elem *a, const struct list_elem *b, void *aux);

/* Compares threads by wake-up time (used in sleep list). */
